...
public class Account {
    ...
    public Account(String ID, String Name, String IC,String Gender, String Religion, String Mobile, String Email, String AccountType, String Address, String DepositAmount, String Password){
        this.ID = ID;
        this.Name = Name;
        this.IC = IC;
        this.Gender = Gender;
